...
static const uint16_t NUM_ERROR_CORRECTION_CODEWORDS_M[10] = {
    10, 16, 26, 36, 48, 64, 72, 88, 110, 130
};

static const uint8_t NUM_ERROR_CORRECTION_BLOCKS_M[10] = {
    1, 1, 1, 2, 2, 4, 4, 4, 5, 5
};

static const uint16_t NUM_RAW_DATA_MODULES[10] = {
...
int8_t qrcode_initBytes(QRCode *qrcode, uint8_t *modules, uint8_t version, uint8_t ecc, uint8_t *data, uint16_t length) {
    ...
    uint8_t eccFormatBits = 0; // ECC_MEDIUM
    uint16_t moduleCount = NUM_RAW_DATA_MODULES[version - 1];
    uint16_t dataCapacity = (uint16_t)(moduleCount / 8 - NUM_ERROR_CORRECTION_CODEWORDS_M[version - 1]);
    if (length > dataCapacity) return -1;

    struct BitBucket codewords;
    // Versions 1..10 => max size 57x57 => 3249 bits => 407 bytes
